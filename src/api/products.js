...
export const products = [
  {
    ...
    category: 'Pulver',
    price: 1.29,
    image: publicAsset('products/kaiser-natron-pulver-50-g-beutel.webp'),
    href: '/shop/kaiser-natron-pulver-50-g-beutel',
    inStock: true,
    keywords: ['natron', 'backsoda', 'bicarbonat', 'natriumhydrogencarbonat', 'baking soda'],
    properties: ['glutenfrei', 'laktosefrei', 'vegan', 'neutralisiert-saeuren', 'enthaertet', 'mild-alkalisch'],
  },
  {
  ...
  },
  {
    ...
    category: 'Pulver',
    price: 29.9,
    image: publicAsset('products/kaiser-natron-pulver-3.490-g-eimer.webp'),
  ...
  },
  {
    ...
    category: 'Tabletten',
    price: 3.49,
    image: publicAsset('products/kaiser-natron-tabletten-100-g-dose.webp'),
    href: '/shop/kaiser-natron-tabletten-100-g-dose',
    inStock: true,
    keywords: ['natron', 'tabletten', 'magen', 'sodbrennen', 'verdauung'],
    properties: ['glutenfrei', 'laktosefrei', 'vegan', 'fuer-kueche-und-haushalt'],
  },
  {
    ...
    properties: ['mit-entspannendem-apfelsinenduft', 'ohne-konservierungsstoffe', 'ohne-mineraloel', 'frei-von-tierischen-substanzen'],
  },
  {
    ...
    category: 'Körperpflege',
    price: 5.49,
    image: publicAsset('products/kaiser-natron-fussbad-500-g.webp'),
    href: '/shop/kaiser-natron-fussbad-500-g',
    inStock: true,
    keywords: ['fusspflege', 'basenbad', 'wellness', 'entspannung'],
    properties: ['mit-dem-duft-der-latschenkiefer', 'wohltuend-und-erfrischend', 'ohne-konservierungsstoffe', 'ohne-mineraloel', 'frei-von-tierischen-substanzen'],
  },
  {
    ...
    category: 'Wäsche',
    price: 6.9,
    image: publicAsset('products/kaiser-natron-daunenwasch-250-ml.webp'),
    href: '/shop/kaiser-natron-daunenwasch-250-ml',
    inStock: true,
    keywords: ['daunen', 'wäsche', 'bettdecke', 'kissen', 'pflege'],
    properties: ['mit-pflegendem-lanolin', 'frei-von-mikroplastik'],
  },
  {
    ...
    category: 'Sport',
    price: 7.9,
    image: publicAsset('products/kaiser-natron-sport-profi-250-ml.webp'),
    href: '/shop/kaiser-natron-sport-profi-250-ml',
    inStock: true,
    keywords: ['sport', 'wäsche', 'funktionskleidung', 'geruch'],
    properties: ['frei-von-mikroplastik'],
  },
  {
    ...
    category: 'Reinigung',
    price: 3.9,
    image: publicAsset('products/kaiser-natron-spuelmittel-500-ml.webp'),
    href: '/shop/kaiser-natron-spuelmittel-500-ml',
    inStock: true,
    keywords: ['geschirr', 'spülen', 'küche', 'reinigung'],
    properties: ['mit-pampelmusenduft', 'hautvertraeglich-dermatologisch-bestaetigt', 'frei-von-mikroplastik'],
  },
  {
    ...
    category: 'Reinigung',
    price: 4.49,
    image: publicAsset('products/kaiser-natron-allzweck-reiniger-750-ml.webp'),
    href: '/shop/kaiser-natron-allzweck-reiniger-750-ml',
    inStock: true,
    keywords: ['reinigung', 'allzweck', 'universal', 'haushalt'],
    properties: ['hygienische-sauberkeit', 'fuer-boeden-und-oberflaechen', 'mit-pampelmusenduft', 'vegan', 'ohne-konservierungsstoffe', 'frei-von-mikroplastik'],
  },
  {
    ...
    category: 'Reinigung',
    price: 4.9,
    image: publicAsset('products/kaiser-natron-allzweck-spray-500-ml.webp'),
    href: '/shop/kaiser-natron-allzweck-spray-500-ml',
    inStock: true,
    keywords: ['reinigung', 'allzweck', 'spray', 'haushalt'],
    properties: ['nachhaltig-durch-tenside-nachwachsenden-ursprungs', 'ohne-konservierungsstoffe', 'mit-natuerlicher-seife', 'frei-von-mikroplastik'],
  },
  {
  ...
  },
  {
    ...
    category: 'Reinigung',
    price: 6.9,
    image: publicAsset('products/holste-handwaschpaste-500-ml.webp'),
  ...
  },
  {
    ...
    category: 'Reinigung',
    price: 5.9,
    image: publicAsset('products/holste-kalk--und-urinsteinloeser-750-ml.webp'),
  ...
  },
  {
    ...
    category: 'Wäsche',
    price: 3.9,
    image: publicAsset('products/holste-reisstaerke-250-g-faltschachtel.webp'),
  ...
  },
  {
    ...
    category: 'Reinigung',
    price: 6.49,
    image: publicAsset('products/holste-schmierseife-fluessig-1-l-flasche.webp'),
  ...
  },
  {
    ...
    category: 'Reinigung',
    price: 4.9,
    image: publicAsset('products/holste-zitronensaeure-entkalker-fluessig-500-ml.webp'),
  ...
  },
  {
    ...
    category: 'Wäsche',
    price: 5.9,
    image: publicAsset('products/gazelle-waeschestaerke-1000-ml-flasche.webp'),
  ...
  },
  {
    ...
    category: 'Reinigung',
    price: 7.9,
    image: publicAsset('products/gruene-tante-mit-quarzmehl-500-ml-dose.webp'),
  ...
  },
  {
    ...
    category: 'Wäsche',
    price: 4.9,
    image: publicAsset('products/linda-fleckenweg-200-ml-tube.webp'),
  ...
  },
  {
    ...
    category: 'Reinigung',
    price: 5.49,
    image: publicAsset('products/linda-neutral-375-ml-dose.webp'),
