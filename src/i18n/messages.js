...
const de = {
  ...
  'kaiserhacks.labels.watchVideo': 'Video ansehen',
  'kaiserhacks.labels.openVideo': 'Video öffnen',
  'kaiserhacks.labels.mockPlayer': 'Video-Platzhalter',
  'kaiserhacks.labels.community': 'Community',
  'kaiserhacks.labels.handoffNote': 'Die Videos sind Mockdaten. Titel, Texte, Poster und Videoquellen sind so strukturiert, dass sie direkt aus dem Backend geliefert werden können.',
...
const en = {
  ...
  'kaiserhacks.labels.watchVideo': 'Watch video',
  'kaiserhacks.labels.openVideo': 'Open video',
  'kaiserhacks.labels.mockPlayer': 'Video placeholder',
  'kaiserhacks.labels.community': 'Community',
  'kaiserhacks.labels.handoffNote': 'Videos are mocked. Titles, copy, posters, and video sources are structured so the backend can provide them directly.',
